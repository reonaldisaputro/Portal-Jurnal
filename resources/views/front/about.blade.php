...
@section('content')
    ...
    <body class="font-[Poppins]" style="background-image: url('{{ asset('assets/images/thumbnails/headers.png') }}')">
        ...
        <div class="flex gap-5 items-center mx-64">
            <div>
                <p class="text-white font-bold text-5xl pb-5">Tentang PKUMI</p>
        ...
        <div class="bg-white px-32 pt-20">
            <div class="flex items-center gap-5">
                <div class="bg-[#F5F5F5] rounded-xl p-5 w-4/6">
        ...
        <div class="bg-white px-32 pb-32 pt-32">
