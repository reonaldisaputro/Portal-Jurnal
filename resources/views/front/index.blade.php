    ...
    <x-navbar />
        ...
        <section id="Latest-entertainment" class="max-w-[1130px] md:mx-auto mx-3 flex flex-col gap-[30px] mt-[70px]">
            ...
            <div class="md:flex justify-between items-center h-fit">
                ...
                <div class="h-[424px] md:w-3/6 w-fit px-5 overflow-y-scroll overflow-x-hidden relative custom-scrollbar">
    ...
    <footer class="bg-[#1A143C] text-white mt-10 pt-20">
        <div class="grid md:grid-cols-3 gap-5 mb-5 px-20">
            <div>
                ...
                <p class="my-3">Pendidikan Kader Ulama Masjid Istiqlal (PKU-MI) adalah platform akademik yang menghimpun jurnal dan karya ilmiah dari mahasiswa di seluruh Indonesia. Kami berkomitmen untuk menjadi pusat rujukan ilmu pengetahuan dan kajian Islam, sekaligus memajukan dakwah digital di era modern.</p>
            ...
            <div>
                ...
                <ul class="list-disc ml-5 pl-5">
                    <li><span class="font-bold">Alamat: </span>Masjid Istiqlal, Jl.Taman Wijaya Kusuma, Jakarta Pusat, Indonesia</li>
