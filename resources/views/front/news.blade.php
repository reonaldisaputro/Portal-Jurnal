...
@section('content')
    ...
    <body class="font-[Poppins]" style="background-image: url('{{ asset('assets/images/thumbnails/headers.png') }}')">
        ...
        <div class="bg-white px-20 pt-20">
            <div class="flex items-center justify-center gap-10 bg-[#F5F5F5] py-3 rounded-xl">
        ...
        <div class="bg-white grid grid-cols-2 gap-3 px-20">
            <div class="bg-white shadow-xl w-full rounded-lg flex gap-3 p-3">
                <img src="{{ asset('assets/images/thumbnails/artikel-news.png') }}" alt="" class="rounded-lg">
                <div>
                    <p class="font-semibold">12 Tren Desain Islam untuk 2023</p>
                    <p class="text-xs font-thin py-7 text-[#3E3232BF]">Dunia seni dan desain Islam berkembang dengan cepat. Untuk berkembang di bidang ini, desainer harus mengantisipasi tantangan baru dan merangkul keindahan tradisi.</p>
        ...
        <div class="bg-white px-20">
            <div class="flex gap-7">
                <div class="relative rounded-lg w-full h-[30rem]" style="background-image: url('{{ asset('assets/images/thumbnails/headers.png') }}'); background-size: cover; background-position: center;">
                    ...
                    <div class="absolute bottom-2 bg-white p-2 rounded-lg mx-3">
                        ...
                        <p class="text-xs">Tauhid adalah makna Laa Ilaaha Illallah ini adalah bagian dari pembahasan tabligh akbar berjudul Keesaan Allah Ta’ala yang disampaikan oleh Syaikh Prof. Dr. ‘Abdur Razzaq bin ‘Abdil Muhsin Al-Badr.</p>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-2">
                    <div class=" h-max mx-auto bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="flex">
                            <!-- Gambar -->
                            <img class="w-32 object-cover rounded-l-lg" src="{{ asset('assets/images/thumbnails/headers.png') }}" alt="Tauhid">
                            <!-- Konten -->
                            <div class="p-4">
                                <h2 class="text-lg font-semibold text-gray-800">5 Alasan Mengapa Anda Harus Menguasai Tauhid</h2>
                                <p class="text-sm text-gray-600 mt-2">
                                    Jadi, Anda Akhirnya Pergi Ke Kelas Boxing Pertama Anda Dan Mempelajari Dasar-Dasar Olahraga Ini. Anda Juga Belajar Bahwa Disarankan Untuk Membungkus Tangan Sebelum Mengenakan Sarung...
                                </p>
                            </div>
                        </div>
                    </div>
