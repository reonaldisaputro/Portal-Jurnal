...
<div id="mobile-menu" class="md:hidden fixed inset-0 h-max sticky top-0 bg-white p-5 hidden opacity-0 transform -translate-y-5 transition-all duration-300 z-[9999]">
    <!-- Close Button ("X") -->
