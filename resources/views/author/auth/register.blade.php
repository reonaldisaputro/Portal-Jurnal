        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('author.register.process') }}"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="author@gmail.com" value="{{ old('email') }}" required="">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <input type="text" name="occupation" id="occupation"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="Jurnalis" value="{{ old('occupation') }}" required="">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <input type="text" name="jurusan" id="jurusan"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="Teknik Informatika" value="{{ old('jurusan') }}" required="">
                            </div>
                            <div>
                                <label for="angkatan"
                                ...
                                <input type="number" name="angkatan" id="angkatan"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="2010" value="{{ old('angkatan') }}" required="">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <input type="text" name="facebook" id="facebook"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="" value="{{ old('facebook') }}">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <input type="text" name="linkedin" id="linkedin"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="" value="{{ old('linkedin') }}">
                            </div>
                            <div>
                                <label for="twitter"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="{{ route('login') }}"
                                class="font-medium text-primary-600 hover:underline">Sign in here</a>
                        </p>
                    </form>
                </div>
            </div>
